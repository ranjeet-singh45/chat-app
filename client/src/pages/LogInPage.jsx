  ...
  return (
    <div>
     ...
     sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
        ...
        <img src={assets.logo_big} alt='' className='w-full max-w-[250px]'/>

        {/* -------right------ */}

        <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-5
